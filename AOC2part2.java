...
public class AOC2part2 {
    ...
    private static void checkSum() {
        ...
        computeChecksum(lines);
    }

    // Computes checksum, given ArrayList of each line
    private static void computeChecksum(List<String> lines) {
        ...
        for (String line : lines) {
            ...
            // Adds all numbers on line to arraylist
            while (in.hasNextInt()) {
            ...
            checkSum += getDivisor(lineNumbers);
        }
    ...
    // returns the quotient of the 2 elements in line that divide evenly
    private static int getDivisor(List<Integer> line) {
